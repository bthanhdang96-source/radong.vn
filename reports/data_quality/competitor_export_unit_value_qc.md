...
- 2020: vietnam_markets=65 | with_brazil=60 | with_indonesia=48 | ok=59
- 2021: vietnam_markets=65 | with_brazil=60 | with_indonesia=51 | ok=57
- 2022: vietnam_markets=68 | with_brazil=1 | with_indonesia=54 | ok=51
- 2023: vietnam_markets=70 | with_brazil=0 | with_indonesia=46 | ok=44

## Top 20 Highest Unit Values
...
- 2021 | BRA -> Malta (MLT) | value_usd=3757 | quantity_ton=15.536 | unit_value_usd_per_ton=241.825438 | flag=low_volume_for_competitor_benchmark
- 2021 | BRA -> Marshall Isds (MHL) | value_usd=2665 | quantity_ton=7.419 | unit_value_usd_per_ton=359.212832 | flag=low_volume_for_competitor_benchmark
- 2023 | IDN -> French Polynesia (PYF) | value_usd=10 | quantity_ton=0.02 | unit_value_usd_per_ton=500 | flag=low_volume_for_competitor_benchmark
- 2020 | BRA -> Bolivia (Plurinational State of) (BOL) | value_usd=176 | quantity_ton=0.22 | unit_value_usd_per_ton=800 | flag=low_volume_for_competitor_benchmark
- 2020 | BRA -> Senegal (SEN) | value_usd=19 | quantity_ton=0.02 | unit_value_usd_per_ton=950 | flag=low_volume_for_competitor_benchmark
- 2021 | BRA -> Cameroon (CMR) | value_usd=16 | quantity_ton=0.014 | unit_value_usd_per_ton=1142.857143 | flag=low_volume_for_competitor_benchmark
- 2020 | IDN -> Sri Lanka (LKA) | value_usd=6 | quantity_ton=0.005 | unit_value_usd_per_ton=1200 | flag=low_volume_for_competitor_benchmark
- 2020 | BRA -> India (IND) | value_usd=3847056 | quantity_ton=3132.06 | unit_value_usd_per_ton=1228.282983 | flag=ok
- 2020 | IDN -> India (IND) | value_usd=24567940.86 | quantity_ton=19997.95 | unit_value_usd_per_ton=1228.522967 | flag=ok
- 2020 | BRA -> Ecuador (ECU) | value_usd=6409826 | quantity_ton=5196.8 | unit_value_usd_per_ton=1233.417873 | flag=ok
- 2020 | BRA -> Venezuela (VEN) | value_usd=3242023 | quantity_ton=2548.53 | unit_value_usd_per_ton=1272.114905 | flag=ok
- 2020 | BRA -> Mexico (MEX) | value_usd=79767579 | quantity_ton=60120.914 | unit_value_usd_per_ton=1326.785867 | flag=ok
- 2020 | BRA -> Armenia (ARM) | value_usd=51072 | quantity_ton=38.4 | unit_value_usd_per_ton=1330 | flag=low_volume_for_competitor_benchmark
- 2021 | BRA -> India (IND) | value_usd=3035610 | quantity_ton=2262.066 | unit_value_usd_per_ton=1341.963497 | flag=ok
- 2020 | BRA -> Viet Nam (VNM) | value_usd=9354873 | quantity_ton=6941.128 | unit_value_usd_per_ton=1347.745352 | flag=ok
- 2020 | IDN -> Ecuador (ECU) | value_usd=1008000 | quantity_ton=720 | unit_value_usd_per_ton=1400 | flag=ok
- 2023 | IDN -> Timor-Leste (TLS) | value_usd=137 | quantity_ton=0.0977 | unit_value_usd_per_ton=1402.251791 | flag=low_volume_for_competitor_benchmark
- 2021 | BRA -> Ecuador (ECU) | value_usd=14059130 | quantity_ton=9799.8 | unit_value_usd_per_ton=1434.63438 | flag=ok
- 2020 | VNM -> India (IND) | value_usd=28725594.449 | quantity_ton=19865.187916 | unit_value_usd_per_ton=1446.026817 | flag=ok
- 2021 | IDN -> India (IND) | value_usd=32054202.204 | quantity_ton=22109.62 | unit_value_usd_per_ton=1449.785306 | flag=ok
...
- Low-volume destinations below 50 tons remain flagged because they can produce extreme unit values.
