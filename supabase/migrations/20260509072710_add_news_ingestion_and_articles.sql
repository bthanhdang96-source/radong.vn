...
values
    ('vietnambiz', 'VietnamBiz', 'https://vietnambiz.vn', 'https://vietnambiz.vn/hang-hoa/nong-san.htm', 'html', 'P0', 1, 'public_ok', true, true, false, 1000, 30, array['thi-truong', 'gia-ca', 'nong-san'], 'https://vietnambiz.vn/%', jsonb_build_object('topics', jsonb_build_array('thi-truong', 'gia-ca', 'nong-san'))),
    ('congthuong', 'Cong Thuong', 'https://congthuong.vn', 'https://congthuong.vn/thi-truong/nong-san', 'html', 'P0', 1, 'public_ok', true, true, false, 1000, 30, array['xuat-khau', 'thi-truong', 'nong-san'], 'https://congthuong.vn/%', jsonb_build_object('topics', jsonb_build_array('xuat-khau', 'thi-truong', 'nong-san'))),
