...
import coffeeCompetitorBenchmarkRouter from './coffeeCompetitorBenchmark.js';
import coffeeMarketEventsRouter from './coffeeMarketEvents.js';
import coffeeMirrorGapRouter from './coffeeMirrorGap.js';
...
router.use(coffeeCompetitorBenchmarkRouter);
router.use(coffeeMarketEventsRouter);
router.use(coffeeMirrorGapRouter);
